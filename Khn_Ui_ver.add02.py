...
class DesignerUI(QtWidgets.QDialog):
    ...
    def init_ui(self):
        ...
        f = QtCore.QFile(Path + "/Kim_Ui_Re_Pyside_04.ui")
        #-pyside파일 경로설정
...
#---------------------------------------------------------
    ...
    def create_connection(self):
        ...
        self.ui.loadEyeSetting_bt.clicked.connect(self.)
        self.ui.skinAllClear_bt.clicked.connect(self.)
        self.ui.ctrlConnect_bt.clicked.connect(self.)
        #2025.03.04 추가 버튼 =Dn_03_VT
        

        self.ui.sub_lock_bt.clicked.connect(lambda: self.Sub_lock(self))
        self.ui.sub_unlock_bt.clicked.connect(self.Sub_unlock)
        self.ui.keydelete_bt.clicked.connect(self.key_Delete)
        self.ui.TurtleTurnOff_bt.clicked.connect(self.TurtleTurnOff)
        ...
        #나중에 폴리클 사이즈나 축 조절할 수 있는 버튼들 만들기
