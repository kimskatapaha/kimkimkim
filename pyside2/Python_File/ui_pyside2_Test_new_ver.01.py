...
#---------------------------------------------------------
    ...
    def create_connection(self):
        ...
        self.ui.turtledelete_bt.clicked.connect(self.Turtle_DeleteNode)
...
#---------------------------------------------------------
    ...
    def Turtle_DeleteNode(self = True):
        Turtle_sel = cmds.ls(' TurtleDefaultBakeLayer')
        lock =cmds.lockNode(Turtle_sel , l =0)
        cmds.delete(Turtle_sel)
